...
function isElementVisible(element) {
  if (!element) return false; // let parentElement = element;
...
function (_React$Component) {
  ...
  function JoyrideOverlay() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_targetResizeObserver", null);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTargetResize", function () {
      _this.forceUpdate();
    });
